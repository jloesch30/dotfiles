...
* @returns {string}
*/
module.exports.formatCode = function(code, config, range, verify_output) {
    try {
...
*/
module.exports.IndentType = Object.freeze({
/**
* Indent using tabs (`\t`)
*/
Tabs:0,"0":"Tabs",
...
*/
module.exports.LineEndings = Object.freeze({
/**
...
*/
module.exports.QuoteStyle = Object.freeze({
/**
...
*/
module.exports.CallParenType = Object.freeze({
/**
...
*/
module.exports.CollapseSimpleStatement = Object.freeze({
/**
* Never collapse
*/
Never:0,"0":"Never",
...
*/
module.exports.OutputVerification = Object.freeze({
/**
...
class Config {
    ...
    */
    collapse_simple_statement() {
        const ret = wasm.config_collapse_simple_statement(this.ptr);
        return ret >>> 0;
    }
    /**
    ...
    */
    with_collapse_simple_statement(collapse_simple_statement) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.config_with_collapse_simple_statement(ptr, collapse_simple_statement);
        return Config.__wrap(ret);
    }
}
...
const path = require('path').join(__dirname, 'stylua_lib_bg.wasm');
